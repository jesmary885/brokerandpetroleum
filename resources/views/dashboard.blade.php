...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div>
            <header class="bg-sky-700 sticky top-0" style="z-index: 900">
        ...
        <main>
            ...
            <footer class="bg-white dark:bg-gray-900">
                <section class="h-12 bg-gradient-to-r p-4 text-center dark:from-gray-700 dark:via-gray-800 dark:to-gray-900">
